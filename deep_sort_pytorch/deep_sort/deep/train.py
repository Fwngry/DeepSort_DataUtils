...
# 需要对数据进行transform，增加了Resize-224，防止随机裁剪导致裁剪框大于待裁图像的情况
...
#使用自定义的CustomImageDataset进行数据读取，输入dataset内的csv索引，读取图像和与之对应的label
training_data=CustomDataset.CustomImageDataset('dataset/label.csv','',transform=transform_train)
testing_data=CustomDataset.CustomImageDataset('dataset/label.csv','',transform=transform_test)
